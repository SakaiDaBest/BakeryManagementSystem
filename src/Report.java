...
//==================================================================================================================================================================//
    ...
    public static class SalesReport extends Report{
        ...
        private void sellingMonthHL(Scanner scanner) {
            ...
            String csvFile = "src/Sales.csv";
            String line;
            double[] monthTotals = new double[12]; // Jan=0, Dec=11
        ...
        public void totalSales() {
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
                ...
                // Simple average per transaction (for realism)
                ...
                // A short performance remark (adds realism)
                if (totalSales >= 50000) {
...
//==================================================================================================================================================================//
    ...
    public static class SalesHistoryReport extends Report{
        ...
        private void displaySalesReport(String[] data){
    ...
    public static void main(String[] args) {
        ...
        Report menu = new Report("R000", today) {
            public void displayReport(Scanner scanner) {} // empty override, not used
        };
        menu.showMenu();
    }
